...
import { countInternalLinks } from "../content/content-piece-seo";
...
/** Pure summary from piece rows — same rules as the internal-links page. */
export function summarizeProjectInternalLinks(pieces: PieceRow[]): ProjectInternalLinkSummary {
...
export async function getProjectInternalLinkSummary(
  ...
  return summarizeProjectInternalLinks(pieces);
}
