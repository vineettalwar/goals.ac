...
export type AnalyticsPropertyTokenEnv = {
...
export async function resolveAccessToken(
  ...
  const refreshed = await refreshGoogleTokens(tokens, env);
  return {
...
export function rankGa4Properties(projectUrl: string, properties: Ga4PropertySummary[]) {
