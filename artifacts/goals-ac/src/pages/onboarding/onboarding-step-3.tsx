...
export function OnboardingStep3(props: OnboardingStepProps) {
  const {
    selectedTone, setSelectedTone, wordCount, setWordCount, language, setLanguage,
    isSavingStyle, TONES, LANGUAGES, onStep3Confirm,
  } = props;
