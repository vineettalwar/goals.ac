...
import type { ProjectSummary } from "@/context/active-project-context";
import type {
  KeywordAnalysisResponse,
  TrackedKeywordWithSnapshot,
} from "@workspace/api-client-react";
import type { UseMutationResult, UseQueryResult } from "@tanstack/react-query";
import type { KeywordOpportunity } from "./keyword-tracking-opportunities";
import type { fadeUp as FadeUpFn } from "./keyword-tracking-motion";
...
export type KeywordTrackingViewProps = {
  user: AuthUser | null;
  ...
  error: string | null;
  result: KeywordAnalysisResponse | null;
  selectedTrackedId: number | null;
  setSelectedTrackedId: (id: number | null) => void;
  trackInput: string;
  setTrackInput: (value: string) => void;
  opportunities: KeywordOpportunity[];
  alerts: KeywordRankAlert[];
  isDiscovering: boolean;
  queueingId: number | null;
  trackedKeywords: TrackedKeywordWithSnapshot[];
  chartData: Array<{ date: string; position: number }>;
  trackedQuery: Pick<UseQueryResult<{ trackedKeywords: TrackedKeywordWithSnapshot[] }, unknown>, "isLoading">;
  analyzeMutation: Pick<UseMutationResult<KeywordAnalysisResponse, unknown, unknown, unknown>, "isPending">;
  trackMutation: Pick<UseMutationResult<unknown, unknown, unknown, unknown>, "isPending">;
  deleteMutation: Pick<UseMutationResult<unknown, unknown, { id: number }, unknown>, "isPending" | "mutate">;
  handleDiscoverGaps: () => void | Promise<void>;
  handleQueueOpportunity: (id: number) => void | Promise<void>;
  handleDismissOpportunity: (id: number) => void | Promise<void>;
  handleDismissAlert: (id: number) => void | Promise<void>;
  addKeyword: () => void;
  removeKeyword: (kw: string) => void;
  handleKey: (e: React.KeyboardEvent<HTMLInputElement>) => void;
  handleAnalyze: () => void;
  handleTrackKeyword: (keyword: string) => void;
  difficultyColors: Record<string, string>;
  fadeUp: typeof FadeUpFn;
};
