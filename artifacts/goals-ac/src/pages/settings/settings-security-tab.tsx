...
import { Loader2, User, Cpu, Shield, AlertTriangle, KeyRound, CheckCircle2, XCircle, Trash2, Lock } from "lucide-react";

export function SettingsSecurityTab(props: Record<string, unknown>) {
    const {
