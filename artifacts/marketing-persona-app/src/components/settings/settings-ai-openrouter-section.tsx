...
export function SettingsAiOpenRouterSection({
  canManage,
  initialHasKey = false,
  ...
  return (
    <>
      <div className="paper-card p-6 space-y-4">
        <h2 className="font-semibold">OpenRouter BYOK</h2>
        <p className="text-sm text-muted-foreground">
          Bring your own OpenRouter API key to route generation through OpenRouter model slugs.
        ...
        {hasKey ? (
          <div className="space-y-3">
            <div className="flex items-center gap-3 p-3 rounded-lg bg-emerald-500/10 border border-emerald-500/20">
              ...
              <div>
                <p className="text-sm font-medium">Organization OpenRouter API key connected</p>
          ...
          <Button variant="outline" size="sm" onClick={openDialog}>
            <KeyRound className="mr-2 h-3.5 w-3.5" />Add OpenRouter API key
          </Button>
        ) : (
          <p className="text-sm text-muted-foreground">No organization OpenRouter API key configured.</p>
        )}
      </div>
