...
export function IntegrationsDirectoryPageClient() {
  ...
  return (
    <MarketingPageShell
      hero={
        <PageHero
          ...
          description="Connect the CMS, ESP, and social platforms you already use. goals.ac renders canonical content per destination — Gutenberg, Elementor, headless fields, and more."
    ...
    >
      ...
      <DarkCTABand
        title="Connect your stack on a discovery call"
        description="We scope CMS setup, OAuth, and publish modes as part of every engagement."
