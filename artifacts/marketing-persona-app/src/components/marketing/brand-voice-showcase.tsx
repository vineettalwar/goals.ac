...
const DEMO = {
  ...
  excerpt: `Most CRM reporting still lives in spreadsheets because dashboards show numbers, not decisions. Northwind connects pipeline stages to forecast confidence so revenue leaders see which deals actually close — not just which reps logged activity last week.`,
  internalLinks: [
...
export function BrandVoiceShowcase() {
  return (
    <MarketingSection
      ...
      description="We extract colors, tone, and product links from your site — then cross-link offerings inside every article."
    >
