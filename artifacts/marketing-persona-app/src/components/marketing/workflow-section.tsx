  ...
  return (
    <section ref={sectionRef} className="py-24 bg-background border-t border-border">
      <div className="max-w-5xl mx-auto px-6">
          ...
          {WORKFLOW_ITEMS.map(({ icon: Icon, title, desc }) => (
            <li key={title} className="scroll-reveal">
              <div className="flex gap-5">
                <div className="shrink-0 mt-0.5 inline-flex h-11 w-11 items-center justify-center rounded-xl bg-primary/10 text-primary">
        ...
        <p className="scroll-reveal mt-12 text-sm text-muted-foreground text-center max-w-3xl mx-auto leading-relaxed">
