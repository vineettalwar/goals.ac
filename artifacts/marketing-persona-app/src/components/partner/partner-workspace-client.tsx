...
export function PartnerWorkspaceClient({ projects, organizationName }: Props) {
  ...
  return (
    <div className="px-8 py-8 max-w-6xl space-y-8">
      ...
      <section className="space-y-3" aria-labelledby="partner-scoreboard-heading">
        <div>
      ...
      <aside className="flex flex-wrap items-center justify-between gap-4 rounded-xl border border-primary/15 bg-primary/3 px-5 py-4">
