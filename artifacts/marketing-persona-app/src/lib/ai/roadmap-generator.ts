...
export async function generateRoadmap(
  ...
  const [executiveSummary, phase0, phase1, phase2] = await Promise.all([
    generateSummaryWithRetry(ai, industry, location, stage),
    generatePhaseWithRetry(ai, industry, location, stage, 0),
    generatePhaseWithRetry(ai, industry, location, stage, 1),
    generatePhaseWithRetry(ai, industry, location, stage, 2),
  ]);
