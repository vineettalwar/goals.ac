...
export function startGoogleSearchConsoleOAuth(projectId: number, userId: number): NextResponse {
...
export function startBingWebmasterOAuth(projectId: number, userId: number): NextResponse {
