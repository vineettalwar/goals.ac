    ...
    <OrgIntegrationsView
      ...
      aiPanel={
        <OrgAiProvidersPanel
          ...
          onSaveOpenrouterKey={byok.saveOpenrouterKey}
          onDeleteOpenrouterKey={byok.deleteOpenrouterKey}
          onTestOpenrouterKey={byok.testOpenrouterKey}
          openrouterSaving={byok.openrouterSaving}
          openrouterDeleting={byok.openrouterDeleting}
          onSaveGroqKey={byok.saveGroqKey}
          onDeleteGroqKey={byok.deleteGroqKey}
          onTestGroqKey={byok.testGroqKey}
          groqSaving={byok.groqSaving}
          groqDeleting={byok.groqDeleting}
          onSaveNvidiaKey={byok.saveNvidiaKey}
          onDeleteNvidiaKey={byok.deleteNvidiaKey}
          onTestNvidiaKey={byok.testNvidiaKey}
          nvidiaSaving={byok.nvidiaSaving}
          nvidiaDeleting={byok.nvidiaDeleting}
