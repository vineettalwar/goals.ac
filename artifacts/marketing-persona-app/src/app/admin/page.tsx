...
import { Building2, ChevronRight, FileText, FolderKanban, Users } from "lucide-react";
...
const ADMIN_SECTIONS = [
  {
    href: "/admin/users",
    title: "Users — God View",
    description: "Browse all users, search cross-tenant, and view as any user.",
    icon: Users,
  },
  {
