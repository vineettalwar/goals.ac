...
/**
 * Mirrors Next `partner-demo-checklist.tsx`.
 * Connect uses project integrations (no `/onboarding/connect` in this shell).
 */
export function PartnerDemoChecklist({ projectId, firstPieceId }: PartnerDemoChecklistProps) {
  ...
  const connectHref = `/projects/${projectId}/integrations/cms`;
