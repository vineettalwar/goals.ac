...
/**
 * Persists HMAC nonces in a custom WordPress database table.
 */
class WP_Nonce_Store implements \GoalsAC\Shared\NonceStore {
	 ...
	 *
	 * @param string $nonce Nonce value from the request header.
	 */
	 ...
	 * @param int    $expires_at Unix timestamp when the nonce expires.
	 */
	public function store( string $nonce, int $expires_at ): void {
		global $wpdb;
